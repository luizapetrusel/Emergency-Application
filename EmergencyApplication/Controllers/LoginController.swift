...
class LoginController: UIViewController {
    ...
    @IBAction func loginTapped( _sender: UIButton) {
        ...
        repeat {
            ...
            (mail == userInput && password == passwordInput){
                ...
                attachChildController(myAccountController)
                NotificationCenter.default.post(name: Notification.Name("mailAccount"), object: mail)
                NotificationCenter.default.post(name: Notification.Name("usernameAccount"), object: username)
    ...
    @IBAction func forgotUsernameTapped(_sender: UIButton) {
        navigationController?.pushViewController(ForgotUsernameController(), animated: true)
    }
